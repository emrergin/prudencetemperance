...
<div class="tutorialKutusu"   @click="nextStep">
    <div class="sutun1">
        <transition-group tag="div" name="tutorial" class="tutorialText">
            ...
            <p :key=10 v-if="step>10">Bu örnek turda {{ciktiHesapla()}} puan kazandınız. Her tur puanınız böyle belirlenecek.</p>
    ...
    <div class="sutun2" id="sut2" >
        <div id="futbolTopu" ref="futbolTopu" 
            ...
            :class="[{kirmiziKenarli:step===6},{odakli:step>5},{odaksiz:step<=5} ]">
            <div :class="[{gorunur:step===7},{gorunmez:step!==7}]" class="beliren kirmiziOklar">
                <div >◄</div>
                <div >►</div>
            </div>
        ...
        <img id="girisBoru" src="../assets/kucukboru3.svg" class="beliren" 
        ...
        <div id="kucukBorular" :class="[{gorunur:step<6},{gorunmez:step>=6}]">
            <div id="kucukBoru1" 
...
export default{
    ...
    methods:{
        nextStep(){
            if (this.step!==5 && this.step!==6 && this.step!==8 && this.step!==8  && this.step!==9){                
                this.step++;
            }
            if (this.step===8){
                this.hareket2();
        ...
        boruTasi(e){
            ...
            if (this.secim===kucukBoru.id.slice(9)){this.secim=null;}
