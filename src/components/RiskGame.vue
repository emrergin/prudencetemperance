<template>
    <div class="oyunKutusu" v-if="!oyunSonu">
        ...
        <div id="oyunAsagi">
            ...
            <div id="inputlar">
              <div class="droppable" id="i1"
              :style="{visibility: !secim? `visible` : `hidden`}"> A</div>
            </div>
...
export default {
    ...
    data(){
        return{
            payOffs:[[10,8,15,3],[5,3,7,1],[9,12,10,10],[2,4,1,5],[7,1,4,4]],
            totalRevenue:0,
            totalLoss:0,
            currentRound:0,
            totalRounds:5,
    ...
    methods:{
        ...
        hareket(){  
            ...
            function Asagi(){
                ...
                setTimeout(()=>{kucukEtiketler(ilgiliEtiket)},2400); 
            }
